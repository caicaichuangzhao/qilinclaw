...
- 🖱️ **桌面 GUI 自动化** *(Beta)* — 智能体可操作你的桌面（点击、输入、截图分析）
- 🌍 **中英双语界面** — 一键切换，无需重启
...
| 软件 | 版本要求 | 是否必需 | 下载地址 |
|------|---------|---------|---------|
| **Node.js** | **v20 LTS（强烈推荐）** | ✅ 必需 | [nodejs.org](https://nodejs.org/) |
| **Git** | 任意近期版本 | ✅ 必需 | [git-scm.com](https://git-scm.com/) |
| **Python** | 3.8+ | ❌ 可选 | [python.org](https://www.python.org/) |

> ⚠️ **重要提示：** 强烈建议使用 **Node.js v20 LTS** 版本。较新版本（v22/v24）可能会在没有 C++ 编译工具的电脑上导致原生模块编译错误。如果你在安装时遇到 `better-sqlite3` 相关错误，请切换到 Node.js v20 LTS。
>
...
> ⚠️ **注意：** 此功能尚处于 Beta 阶段，部分操作可能不够稳定。请谨慎使用。
>
> **紧急中断：** 如果 GUI 自动化过程中出现异常操作，**双击 ESC 键**即可强制中断所有 GUI 操作，立即夺回鼠标和键盘控制权。
...
**A:** 双击 ESC 键即可强制中断所有 GUI 操作，立即夺回鼠标和键盘控制权。GUI 功能目前处于 Beta 阶段，如遇问题欢迎反馈。
